...
const AirConditioner = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#AirConditioner__clip0_4482_4842)", children: [
    " ",
    /* @__PURE__ */ jsx("path", { d: "M19 4.5H5C3 4.5 2 5.84 2 7.5V12.5C2 14.16 3 15.5 5 15.5H19C21 15.5 22 14.16 22 12.5V7.5C22 5.84 21 4.5 19 4.5ZM16.5 13.25H7.5C7.09 13.25 6.75 12.91 6.75 12.5C6.75 12.09 7.09 11.75 7.5 11.75H16.5C16.91 11.75 17.25 12.09 17.25 12.5C17.25 12.91 16.91 13.25 16.5 13.25ZM17 8.75H15C14.59 8.75 14.25 8.41 14.25 8C14.25 7.59 14.59 7.25 15 7.25H17C17.41 7.25 17.75 7.59 17.75 8C17.75 8.41 17.41 8.75 17 8.75Z", fill: "currentColor" }),
    " ",
  ...
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "AirConditioner__clip0_4482_4842", children: [
      " ",
