...
const ForwardBackwardDollar = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#ForwardBackwardDollar__clip0_4482_1209)", children: [
    " ",
    ...
    " ",
    /* @__PURE__ */ jsx("path", { d: "M20 13.41C19.99 13.4 19.97 13.4 19.96 13.39C19.36 13.14 18.69 13 18 13C15.24 13 13 15.24 13 18C13 18.71 13.15 19.39 13.41 20C14.19 21.76 15.95 23 18 23C18.69 23 19.36 22.86 19.96 22.61C21.74 21.84 23 20.07 23 18C23 15.95 21.76 14.19 20 13.41ZM17.64 19.9C17.64 20.21 17.46 20.48 17.17 20.59C17.08 20.63 16.98 20.65 16.89 20.65C16.69 20.65 16.5 20.58 16.36 20.43L14.78 18.85C14.49 18.56 14.49 18.09 14.78 17.79C15.07 17.5 15.54 17.5 15.84 17.79L16.14 18.09V16.1C16.14 15.68 16.47 15.35 16.89 15.35C17.3 15.35 17.64 15.68 17.64 16.1V19.9ZM21.22 18.21C20.93 18.5 20.46 18.5 20.16 18.21L19.86 17.91V19.9C19.86 20.32 19.53 20.65 19.11 20.65C18.7 20.65 18.36 20.32 18.36 19.9V16.1C18.36 15.79 18.54 15.52 18.83 15.41C19.1 15.29 19.43 15.35 19.64 15.57L21.22 17.15C21.51 17.44 21.51 17.91 21.22 18.21Z", fill: "currentColor" }),
    " ",
  ...
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "ForwardBackwardDollar__clip0_4482_1209", children: [
      " ",
