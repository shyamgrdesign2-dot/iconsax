...
const ForwardBackwardCard1 = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#ForwardBackwardCard1__clip0_4482_1210)", children: [
    " ",
    ...
    " ",
    /* @__PURE__ */ jsx("path", { d: "M20 13.41C19.99 13.4 19.97 13.4 19.96 13.39C19.36 13.14 18.69 13 18 13C15.24 13 13 15.24 13 18C13 18.71 13.15 19.39 13.41 20C14.19 21.76 15.95 23 18 23C18.69 23 19.36 22.86 19.96 22.61C21.74 21.84 23 20.07 23 18C23 15.95 21.76 14.19 20 13.41ZM20.4301 19.64L18.85 21.22C18.71 21.37 18.5199 21.44 18.3199 21.44C18.1299 21.44 17.94 21.37 17.79 21.22C17.5 20.93 17.5 20.45 17.79 20.16L18.09 19.86H16.1C15.68 19.86 15.35 19.53 15.35 19.11C15.35 18.7 15.68 18.36 16.1 18.36H19.9C20.21 18.36 20.48 18.54 20.59 18.83C20.71 19.11 20.6501 19.43 20.4301 19.64ZM19.9 17.64H16.1C15.79 17.64 15.52 17.46 15.41 17.17C15.29 16.89 15.3499 16.57 15.5699 16.36L17.15 14.78C17.44 14.49 17.91 14.48 18.21 14.78C18.5 15.07 18.5 15.55 18.21 15.84L17.91 16.14H19.9C20.32 16.14 20.65 16.47 20.65 16.89C20.65 17.3 20.32 17.64 19.9 17.64Z", fill: "currentColor" }),
    " ",
  ...
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "ForwardBackwardCard1__clip0_4482_1210", children: [
      " ",
