...
const BackwardDollar = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#BackwardDollar__clip0_4482_1213)", children: [
    " ",
    ...
    " ",
    /* @__PURE__ */ jsx("path", { d: "M20 13.41C19.99 13.4 19.97 13.4 19.96 13.39C19.36 13.14 18.69 13 18 13C15.24 13 13 15.24 13 18C13 18.71 13.15 19.39 13.41 20C14.19 21.76 15.95 23 18 23C18.69 23 19.36 22.86 19.96 22.61C21.74 21.84 23 20.07 23 18C23 15.95 21.76 14.19 20 13.41ZM19.9 19.04H16.1C15.79 19.04 15.52 18.86 15.41 18.58C15.29 18.3 15.3499 17.97 15.5699 17.76L17.15 16.18C17.44 15.89 17.91 15.89 18.21 16.18C18.5 16.47 18.5 16.95 18.21 17.24L17.91 17.54H19.9C20.32 17.54 20.65 17.88 20.65 18.29C20.65 18.7 20.32 19.04 19.9 19.04Z", fill: "currentColor" }),
    " ",
  ...
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "BackwardDollar__clip0_4482_1213", children: [
      " ",
