...
const RemoveBasket = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#RemoveBasket__clip0_4482_3537)", children: [
    " ",
    ...
    " ",
    /* @__PURE__ */ jsx("path", { d: "M15.1998 7.75C14.7898 7.75 14.4498 7.41 14.4498 7V5.2C14.4498 3.85 13.3498 2.75 11.9998 2.75C10.6498 2.75 9.5498 3.85 9.5498 5.2V7C9.5498 7.41 9.2098 7.75 8.7998 7.75C8.3898 7.75 8.0498 7.41 8.0498 7V5.2C8.0498 3.02 9.81982 1.25 11.9998 1.25C14.1798 1.25 15.9498 3.02 15.9498 5.2V7C15.9498 7.42 15.6098 7.75 15.1998 7.75Z", fill: "currentColor" }),
    " ",
  ...
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "RemoveBasket__clip0_4482_3537", children: [
      " ",
