...
const ConvertHome2 = (props) => /* @__PURE__ */ jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", ...props, children: [
  " ",
  /* @__PURE__ */ jsxs("g", { clipPath: "url(#ConvertHome2__clip0_4482_10478)", children: [
    " ",
    ...
    " ",
    /* @__PURE__ */ jsx("path", { opacity: "0.4", d: "M22.1096 5.7402V8.4902C22.1096 9.8802 20.9796 11.0002 19.5996 11.0002H15.3196C13.9296 11.0002 12.8096 9.8702 12.8096 8.4902V6.1902C12.8096 5.4302 13.1596 4.7002 13.7496 4.2302L15.8396 2.5602C16.7596 1.8302 18.0596 1.8302 18.9796 2.5602L21.5996 4.6502C21.9296 4.9102 22.1196 5.3202 22.1196 5.7402H22.1096Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
    " ",
    /* @__PURE__ */ jsx("path", { opacity: "0.4", d: "M11.1098 16.7402V19.4902C11.1098 20.8802 9.9798 22.0002 8.5998 22.0002H4.3098C2.9198 22.0002 1.7998 20.8702 1.7998 19.4902V17.1902C1.7998 16.4302 2.1498 15.7002 2.7398 15.2302L4.8298 13.5602C5.7498 12.8302 7.0498 12.8302 7.9698 13.5602L10.5898 15.6502C10.9198 15.9102 11.1098 16.3202 11.1098 16.7402Z", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }),
    " "
  ] }),
  " ",
  /* @__PURE__ */ jsxs("defs", { children: [
    " ",
    /* @__PURE__ */ jsxs("clipPath", { id: "ConvertHome2__clip0_4482_10478", children: [
      " ",
